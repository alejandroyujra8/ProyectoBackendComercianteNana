...
import { ArrowRight, Sparkles, ShoppingBag, MapPin, Trophy, X, ShoppingCart } from 'lucide-react';
...
export function PantallaDeInicio() {
  ...
  const filtrados = categoria === 'Todos' 
    ? lista_de_juegos 
    : lista_de_juegos.filter(j => j.categoria === categoria);

  return (
    <div className="container mt-4 mb-5">
      <section className="position-relative d-flex flex-column justify-content-end p-4 p-md-5 text-white mb-5 shadow-sm"
        style={{ 
          minHeight: '450px', 
          borderRadius: '45px', 
        ...
        <div className="position-relative z-1">
          ...
          <p className="fs-5 mb-4 opacity-75">¿Podrás encontrar al fascista antes de que sea tarde?</p>
